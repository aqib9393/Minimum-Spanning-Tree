...
namespace Kruskal
{
    public partial class Kruskal : Form
    {
        ...
        Color counter_color = Color.Red;
        Color Counter_Edge_Color = Color.Red;
        ...
        private void panel1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                counter.Add(new Node(counter.Count, pClicked));
                panelKruskal.Invalidate();
            }
        }
        ...
        private void Solve_Click(object sender, EventArgs e)
        {
            if (counter.Count > 2)
            {
                if (m_lstEdgesInitial.Count < counter.Count - 1)
                {
        ...
        {
            Pen P = new Pen(Counter_Edge_Color);
        ...
        {
            Pen P = new Pen(counter_color);
            Brush B = new SolidBrush(counter_color);
            foreach (Node v in counter)
            {
